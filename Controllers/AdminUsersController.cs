...
namespace minipj.Controllers
{
    public class AdminUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserName,RoleUser,PasswordUser")] AdminUser adminUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserName,RoleUser,PasswordUser")] AdminUser adminUser)
        {
            if (ModelState.IsValid)
            {
